  ...
  return (
    <aside className="w-60 bg-navy-700 text-white flex-shrink-0 flex flex-col overflow-y-auto">
      ...
      <nav className="flex-1 py-4 space-y-0.5 text-sm">
        ...
        <NavItem href="/megan" icon={<UserRound className="w-4 h-4" />} label="Production Manager" />
        <NavItem href="/csr-home" icon={<UserRound className="w-4 h-4" />} label="CSR" />
        <NavItem href="/colorist" icon={<UserRound className="w-4 h-4" />} label="Colorist" />
        <NavItem href="/print-op-home" icon={<UserRound className="w-4 h-4" />} label="Print Operator" />
        <NavItem href="/finishing-home" icon={<UserRound className="w-4 h-4" />} label="Finishing" />
        <NavItem href="/cut-sew-home" icon={<UserRound className="w-4 h-4" />} label="Cut/Sew" />
        ...
        <NavItem href="/returns" icon={<RotateCcw className="w-4 h-4" />} label="Returns / RMAs" />
        ...
        <NavItem href="/it-admin" icon={<ServerCog className="w-4 h-4" />} label="IT / System Admin" />
