...
const EXCEPTIONS: ExceptionRow[] = [
  // NeoStampa Phase 1 — RIP-related exception types
  { id: 'EX-2426', type: 'NeoStampa Agent Offline', severity: 'critical',
    related: { kind: 'Agent', ref: 'RIP-Bay-C', href: '/it-admin' },
    default_role: 'admin', owner: null, status: 'Open',
    opened: '2m ago', sla_clock: '13m to escalate', sla_state: 'warn',
    notes: 'NeoStampa Sync Agent on rip-bay-c.adt.local stopped reporting heartbeats. 4 active RIP jobs on JP4-A/B are blocked. Likely cause: NeoStampa 11.1 service crash — restart needed.' },
  { id: 'EX-2425', type: 'Hot Folder Unreachable', severity: 'high',
    related: { kind: 'Hot Folder', ref: 'Durst Alpha 330 — STANDARD', href: '/it-admin' },
    default_role: 'admin', owner: null, status: 'Open',
    opened: '6m ago', sla_clock: '44m to escalate', sla_state: 'warn',
    notes: 'Hot folder \\\\rip-bay-a\\hotfolder\\durst-alpha-330\\standard\\ is not writable. 2 RipJobs failed submission. Check network share permissions + RIP machine uptime.' },
  { id: 'EX-2424', type: 'Duplicate External Job Name', severity: 'medium',
    related: { kind: 'RIP Job', ref: 'PR-12091', href: '/print-requests/1' },
    default_role: 'colorist', owner: 'Jeannine R.', status: 'Open',
    opened: '13m ago', sla_clock: '37m to escalate', sla_state: 'ok',
    notes: 'External job name STFRANK_PR-12091_FO-98432_BLOOM-BLUE_24YD collides with an in-flight job. Reprint workflow needs to include a sequence suffix (e.g. _R2) on retries.' },
  { id: 'EX-2423', type: 'RIP Failure', severity: 'high',
    related: { kind: 'RIP Job', ref: 'PR-12088', href: '/print-requests/1' },
    default_role: 'colorist', owner: null, status: 'Open',
    opened: '21m ago', sla_clock: '29m to escalate', sla_state: 'warn',
    notes: 'NeoStampa rejected the package with "missing ICC profile". Auto-retry exhausted (3 attempts). Likely cause: ICC mapping change not yet propagated to RIP-Bay-B.' },
  { id: 'EX-2422', type: 'QR Confirmation Missing', severity: 'medium',
    related: { kind: 'PR', ref: 'PR-12077', href: '/print-requests/1' },
    default_role: 'print_op', owner: 'Julio V.', status: 'In Progress',
    opened: '34m ago', sla_clock: '16m to escalate', sla_state: 'warn',
    notes: 'NeoStampa reports Print Complete (software) but the QR has not been physically scanned at the printer exit. Software status ≠ truth. Either the QR is missing/misprinted or the scanner missed it — Julio is checking the leader.' },
