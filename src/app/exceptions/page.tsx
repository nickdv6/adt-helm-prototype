...
const EXCEPTIONS: ExceptionRow[] = [
  ...
  { id: 'EX-2417', type: 'Hot Folder Routing Failure', severity: 'high',
    ...
    notes: 'Destination hot folder for MS JP4 unreachable — network share offline. IT notified.' },
  ...
  { id: 'EX-2410', type: 'Printer Queue Stale', severity: 'medium',
    ...
    notes: '22 files in MS JP4 hot folder, oldest 73 min. Julio acknowledged + cleared backlog.' },
